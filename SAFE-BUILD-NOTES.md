...
This build preserves the full multi-page project flow while disabling runtime transmission of sensitive form data to external messaging.
...
- external messaging API endpoints/tokens/chat IDs are removed from runtime HTML pages.
